...
venue: "University of Vermont and VBRN"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
address: "Leahy, 105 Carrigan Drive, Burlington, VT 05405"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
country: "us"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes) for the institution that hosts the workshop
language: "en"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) for the workshop
latitude: "44.477094618048916"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "-73.19472956019816"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "Jan 7-8, 2025"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Princess Rodriguez", "Emily Curd"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Heather Driscoll", "Julie Dragon", "Ramiro Barrantes-Reynolds"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["Princess.Rodriguez@uvm.edu","eecurd@uvm.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes:  https://etherpad.wikimedia.org/p/UVM-VBRN-Metagenomics-01072025 # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
eventbrite: "1076086245929" # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
...
{% comment %}
nsh - tshooting here whether raw will display any differently
<iframe
...
{% endcomment %}
{% raw %}
<iframe src="https://www.eventbrite.com/tickets-external?eid=1076086245929&ref=etckt" frameborder="0" width="100%" height="380px" scrolling="auto" >&nbsp;</iframe>
{% endraw %}
{% endif %}
